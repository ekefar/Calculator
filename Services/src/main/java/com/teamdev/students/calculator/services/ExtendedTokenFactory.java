...
import com.teamdev.students.calculator.services.commands.ExtendedCommandFactory;

/**
 * Represents token factory with additional operations
 */
public class ExtendedTokenFactory implements TokenFactory {
    /**
    ...
    public CommandFactory getCommandFactory() {
        return new ExtendedCommandFactory();
    }
}
